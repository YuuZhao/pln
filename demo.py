...
#export PYTHONPATH=/home/yuuzhao/Documents/project/pysot:$PYTHONPATH
    ...
    for frame in get_frames(args.video_name):
       ...
       # os.system("pause")
        ...
        if first_frame:
            ...
            #yy
            #print(init_rect)
            cropRect0 = frame[init_rect[1]:init_rect[1]+init_rect[3], init_rect[0]:init_rect[0]+init_rect[2]]
            ...
            cropRectI = frame[track_rect[1]:track_rect[1]+track_rect[3], track_rect[0]:track_rect[0]+track_rect[2]]
